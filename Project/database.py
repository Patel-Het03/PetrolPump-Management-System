...
c = mydb.cursor()
def create_table(): 
   c.execute('CREATE TABLE IF NOT EXISTS Petrolpump (Registration_No varchar(10) NOT NULL, Petrolpump_Name varchar(50) NOT NULL, Latitude int(3) DEFAULT NULL, Longitude int(3) DEFAULT NULL, Company_Name varchar(30) DEFAULT NULL, Opening_Year int(5) DEFAULT NULL, State varchar(30) DEFAULT NULL,City varchar(40) NOT NULL, PRIMARY KEY(Registration_No))')
...
def add_Petrolpump_data(Registration_No,Petrolpump_Name, Latitude, Longitude, Company_Name,Opening_Year,State,City):
    c.execute('insert into Petrolpump (Registration_No,Petrolpump_Name,Latitude,Longitude,Company_Name,Opening_Year,State,City) values (%s,%s,%s,%s,%s,%s)',(Registration_No,Petrolpump_Name,Company_Name,Opening_Year,State,City) )
    mydb.commit()
